...
<head>
    ...
    <script src="/sboard/js/checkPass.js"></script>
    <script src="/sboard/js/checkName.js"></script>
    <script src="/sboard/js/checkNick.js"></script>
    <script src="/sboard/js/checkEmail.js"></script>
    <script src="/sboard/js/checkHp.js"></script>
